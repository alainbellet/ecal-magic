            ...
            switch (imageTargetResult.Status)
            {
                case MLImageTracker.Target.TrackingStatus.Tracked:
                    ...
                    if (TrackedImageFollower != null)
                    {
                        ...
                        TrackedImageFollower.transform.position = Vector3.Lerp(TrackedImageFollower.transform.position, ImagePos,lerp);
                        TrackedImageFollower.transform.rotation = Quaternion.Slerp(TrackedImageFollower.transform.rotation, ImageRot,lerp);
                    }
